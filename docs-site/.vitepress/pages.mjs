export const groups = [
  ...
  { text: '技术方案', items: [['technical/architecture', '架构与职责'], ['technical/development-steps', '开发实施步骤'], ['technical/page-plan-v2', '页面规划 V2'], ['technical/page-functional-design', '页面功能设计与完成表'], ['technical/product-and-ui-plan', '产品、技术栈与 UI'], ['technical/dependency-baseline', '依赖基线'], ['technical/ui-options', 'UI 候选方案'], ['technical/compatibility', '客户端兼容性'], ['technical/security', '安全方案']] },
