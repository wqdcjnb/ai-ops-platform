export const groups = [
  ...
  { text: '技术方案', items: [['technical/architecture', '架构与职责'], ['technical/product-and-ui-plan', '产品、技术栈与 UI'], ['technical/dependency-baseline', '依赖基线'], ['technical/ui-options', 'UI 候选方案'], ['technical/compatibility', '客户端兼容性'], ['technical/security', '安全方案']] },
  { text: '部署与使用', items: [['guides/cpa', 'CPA 使用说明'], ['guides/clients', '客户端接入验证'], ['guides/maintenance', '文档站使用与维护']] },
