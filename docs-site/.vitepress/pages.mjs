export const groups = [
  ...
  { text: '技术方案', items: [['technical/architecture', '架构与职责'], ['technical/product-and-ui-plan', '产品、技术栈与 UI'], ['technical/ui-options', 'UI 候选方案'], ['technical/compatibility', '客户端兼容性'], ['technical/security', '安全方案']] },
