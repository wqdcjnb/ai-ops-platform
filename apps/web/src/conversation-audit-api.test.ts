...
describe('conversation audit API contracts', () => {
  it('validates metadata-only list boundaries and filters', () => {
    ...
    const response = { meta: { source: 'demo', generatedAt: '2026-09-15T10:00:00.000Z', period: '7d', notice: '演示' }, accessControl: { currentRole: 'super_admin', serverRbacVerified: false, contentRequiresReason: true, notice: '待验证' }, summary: { total: 1, captured: 1, metadataOnly: 0, expiringSoon: 0, independentCalls: 0, reviewRequired: 0 }, scope: { defaultCaptureEnabled: false, activePolicies: 1, nearestExpiryAt: '2026-09-16T10:00:00.000Z', storageEncryptedVerified: false, accessAuditPersisted: false, notice: '待验证' }, options: { people: [], keys: [], purposes: [], models: [], policies: [] }, items: [record], pagination: { page: 1, pageSize: 10, total: 1, totalPages: 1 } }
