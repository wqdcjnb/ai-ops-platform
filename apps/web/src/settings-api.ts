...
export const settingsResponseSchema = z.object({
  ...
  organization: z.object({ source: sourceStateSchema, company: z.string(), departments: z.number().int().nonnegative(), people: z.number().int().nonnegative(), roles: z.array(roleSchema) }),
