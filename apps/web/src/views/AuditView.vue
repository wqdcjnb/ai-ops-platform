...
const resourceText = { session: '会话', authorization: '权限校验', person: '人员', key: 'Key', quota: '额度', route: '路由', export: '导出', settings: '设置', alert: '告警', conversation: '对话审计' }
