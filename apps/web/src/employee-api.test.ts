...
describe('employee API contracts', () => {
  it('accepts only self-scoped profiles and masked Keys', () => {
    const profile = { meta: databaseMeta, scope, person: { id: 'person-lin', name: '林梓雨', initials: '林', employeeCode: 'OPS-017', department: '内容运营', role: 'employee', status: 'active', manager: '负责人', joinedAt: '2025-03-17' }, support: { contact: '联系管理员', serviceHours: '工作日', temporaryQuotaRequestAvailable: true, notice: '本地审批' }, commonErrors: [{ code: 'AUTH_INVALID', title: '鉴权失败', explanation: 'Key 无效', action: '检查配置', internalDetailAvailable: false }] }
